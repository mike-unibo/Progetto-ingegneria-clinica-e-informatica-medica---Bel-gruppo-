...
disp = {"Occhi aperti posa standard":" COP sway: eyes open wide stance", 
        "Occhi chiusi posa standard":" COP sway: eyes closed wide stance",
        "Occhi aperti piedi vicini":" COP sway: eyes open narrow stance",
        "Occhi chiusi piedi vicini":" COP sway: eyes closed narrow stance",
        "Occhi aperti piede destro avanti":" COP sway: eyes open right-foot tandem stance",
        "Occhi aperti piede sinistro avanti":" COP sway: eyes open left-foot tandem stance"}

codes = {"Occhi aperti posa standard":["LOC-BAL-SWAY-AP-EO-WIDE", "LOC-BAL-SWAY-ML-EO-WIDE", "LOC-BAL-ELL95-EO-WIDE", "LOC-BAL-COPV-EO-WIDE"], 
        "Occhi chiusi posa standard":["LOC-BAL-SWAY-AP-EC-WIDE", "LOC-BAL-SWAY-ML-EC-WIDE", "LOC-BAL-ELL95-EC-WIDE", "LOC-BAL-COPV-EC-WIDE"],
        "Occhi aperti piedi vicini":["LOC-BAL-SWAY-AP-EO-NARR", "LOC-BAL-SWAY-ML-EO-NARR", "LOC-BAL-ELL95-EO-NARR", "LOC-BAL-COPV-EO-NARR"],
        "Occhi chiusi piedi vicini":["LOC-BAL-SWAY-AP-EC-NARR", "LOC-BAL-SWAY-ML-EC-NARR", "LOC-BAL-ELL95-EC-NARR", "LOC-BAL-COPV-EC-NARR"],
        "Occhi aperti piede destro avanti":["LOC-BAL-SWAY-AP-EO-RTAND", "LOC-BAL-SWAY-ML-EO-RTAND", "LOC-BAL-ELL95-EO-RTAND", "LOC-BAL-COPV-EO-RTAND"],
        "Occhi aperti piede sinistro avanti":["LOC-BAL-SWAY-AP-EO-LTAND", "LOC-BAL-SWAY-ML-EO-RTAND", "LOC-BAL-ELL95-EO-LTAND", "LOC-BAL-COPV-EO-LTAND"]}
...
#nei rispettivi campi della risorsa fhir 'condition' che crea come oggetto fhir.resource
    ...
    condition = Condition(
        clinicalStatus={"coding": [{     #è un codeable concept, non stringa semplice
            "code": "active",
            },]
        },
        subject={"reference": id_pat},
...
def create_fhir_sway(id_pat, task):
    ...
    match task:
        case "Occhi aperti posa standard":
            df_ad = bal_eo
        case "Occhi chiusi posa standard":
            df_ad = bal_ec
        case "Occhi aperti piedi vicini":
            df_ad = bal_eoc
        case "Occhi chiusi piedi vicini":
            df_ad = bal_ecc
        case "Occhi aperti piede destro avanti":
            df_ad = bal_rff
        case "Occhi aperti piede sinistro avanti":
            df_ad = bal_lff
