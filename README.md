...
La cartella **dataset** contiene i file del dataset che sono stati utilizzati: alcuni sono stati processati o riorganizzati rispetto a quelli presenti nel dataset originale su Synapse. Qui si trovano anche i file ottenuti dal signal processing di solette e tappeto sensorizzato per i task di balance. Dovrebbero esserci anche le serie temporali dei sensori delle solette relative ai task di equilibrio, tuttavia essendo file pesanti GitHub non li accetta: li mostreremo eventualmente il giorno dell'esposizione.
