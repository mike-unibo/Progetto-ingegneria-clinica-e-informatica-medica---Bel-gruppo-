...
# UI
# ══════════════════════════════════════════════════════════════════════════════
st.title("Balance - Single Patient Analysis", text_alignment="center")
st.markdown("I partecipanti hanno eseguito 6 sottocompiti di equilibrio statico in stazione eretta, registrati tramite solette sensorizzate e pedana baropodometrica, variando condizione visiva e posizione dei piedi. \n\nIn questa sezione puoi analizzare il profilo posturale di un singolo paziente selezionando l'ID, il gruppo e il task dalla sidebar. Puoi visualizzare la distribuzione delle pressioni plantari tramite heatmap interattiva, esplorarne l'evoluzione temporale e consultare le metriche quantitative di pressione e di Centro di Pressione. È inoltre disponibile una modalità di confronto affiancato per confrontare task diversi dello stesso paziente o pazienti diversi.", text_alignment="justify" )
